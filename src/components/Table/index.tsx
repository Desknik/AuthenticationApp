...
export default function App() {
  ...
  const renderCell = React.useCallback((user: User, columnKey: React.Key) => {
    ...
    switch (columnKey) {
      ...
      case "role":
        return (
          <p className={`text-bold text-small capitalize ${cellValue === 'Administrator' && "text-indigo-500"}`}>{cellValue}</p>
      ...
      return(
        <p className="text-bold text-small text-gray-400 capitalize">Not Linked</p>
      )
